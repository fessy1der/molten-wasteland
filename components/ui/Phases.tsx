...
export function Phases() {
  const data = [
    ...
    {
      title: "Getting into your eyes and ears with the promo",
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
    ...
    {
      title: "Interactive perks go live",
      content: (
        <div>
    ...
    {
      title: "Time for the main sales round",
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
    ...
    {
      title: "Pat on the back for all of us – and let the new journey begin",
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
